...
/**
 * The implementation of StudentList
 */
public class StudentListImpl extends StudentList implements IValueInstance
{
     ...
     */
    public StudentListImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(40 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this StudentList to another StudentList
     * @param studentList  The StudentList to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this StudentList is less than, equal to, or greater
     *                     than the specified StudentList
     */
    public int compareTo(StudentList studentList)
    {
        return edma_domain.valueCompare(value, ((StudentListImpl) studentList).value);
    }
    ...
    {
        return new StudentImpl(value[index]);
    }
    ...
    public class StudentListIterator implements Iterator<Student>
    {
        ...
        public Student next()
        {
            return new StudentImpl(value[pos++]);
        }
