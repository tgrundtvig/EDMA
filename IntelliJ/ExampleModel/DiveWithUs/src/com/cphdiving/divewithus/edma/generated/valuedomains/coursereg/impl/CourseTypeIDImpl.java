...
/**
 * The implementation of CourseTypeID
 */
public class CourseTypeIDImpl extends CourseTypeID implements IValueInstance
{
     ...
     */
    public CourseTypeIDImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(42 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this CourseTypeID to another CourseTypeID
     * @param courseTypeID  The CourseTypeID to compare with
     * @return              A negative integer, zero, or a positive integer as
     *                      this CourseTypeID is less than, equal to, or greater
     *                      than the specified CourseTypeID
     */
    public int compareTo(CourseTypeID courseTypeID)
    {
        return edma_domain.valueCompare(value, ((CourseTypeIDImpl) courseTypeID).value);
    }
