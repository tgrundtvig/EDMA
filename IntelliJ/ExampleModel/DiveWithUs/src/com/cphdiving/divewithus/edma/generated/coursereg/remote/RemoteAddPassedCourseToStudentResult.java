 ...
 * 
 */
public class RemoteAddPassedCourseToStudentResult implements AddPassedCourseToStudentResult
{
     ...
     */
    public RemoteAddPassedCourseToStudentResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
