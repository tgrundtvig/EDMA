 ...
 */
public class MobileImpl extends Mobile implements IValueInstance
{
     ...
     */
    public MobileImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(12 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this Mobile to another Mobile
     * @param mobile  The Mobile to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                Mobile is less than, equal to, or greater than the
     *                specified Mobile
     */
    public int compareTo(Mobile mobile)
    {
        return edma_domain.valueCompare(value, ((MobileImpl) mobile).value);
    }
