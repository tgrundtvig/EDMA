 ...
 * 
 */
public class EDMA_CreateCourseType extends AAction implements IAction
{
    private CreateCourseTypeUserImpl edma_userMethod;
     ...
     */
    public EDMA_CreateCourseType(CreateCourseTypeUserImpl edma_userMethod)
    {
        super("createCourseType");
    ...
    public boolean execute(IDataModelUpdate edma_dm)
    {
        ...
        switch(e)
        {
            case 0:
                ...
                break;
            case 1:
                edma_userMethod.setErrorCode(1, "Course type already exists");
                break;
            default:
                throw new RuntimeException("Error in createCourseType: Invalid error code: " + e);
        }
        if(e == 0)
        {
            if(edma_userMethod.getId() == null)
            {
                throw new RuntimeException("Error in createCourseType: Output parameter id is null");
            }
        }
        return (e == 0);
    }
     ...
     */
    public CreateCourseTypeUserImpl getUserMethod()
    {
