...
/**
 * The implementation of AddressLine
 */
public class AddressLineImpl extends AddressLine implements IValueInstance
{
     ...
     */
    public AddressLineImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(13 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this AddressLine to another AddressLine
     * @param addressLine  The AddressLine to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this AddressLine is less than, equal to, or greater
     *                     than the specified AddressLine
     */
    public int compareTo(AddressLine addressLine)
    {
        return edma_domain.valueCompare(value, ((AddressLineImpl) addressLine).value);
    }
