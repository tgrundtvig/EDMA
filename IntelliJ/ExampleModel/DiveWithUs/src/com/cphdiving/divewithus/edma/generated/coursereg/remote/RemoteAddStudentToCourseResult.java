 ...
 * 
 */
public class RemoteAddStudentToCourseResult implements AddStudentToCourseResult
{
     ...
     */
    public RemoteAddStudentToCourseResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
