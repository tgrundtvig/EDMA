 ...
 */
public class CityImpl extends City implements IValueInstance
{
    ...
    public boolean equals(Object o)
    {
        ...
        if(14 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this City to another City
     * @param city  The City to compare with
     * @return      A negative integer, zero, or a positive integer as this
     *              City is less than, equal to, or greater than the specified
     *              City
     */
    public int compareTo(City city)
    {
        return edma_domain.valueCompare(value, ((CityImpl) city).value);
    }
