 ...
 * 
 */
public class EDMA_SetTeacherOnCourse extends AAction implements IAction
{
    private SetTeacherOnCourseUserImpl edma_userMethod;
     ...
     */
    public EDMA_SetTeacherOnCourse(SetTeacherOnCourseUserImpl edma_userMethod)
    {
        super("setTeacherOnCourse");
    ...
    public boolean execute(IDataModelUpdate edma_dm)
    {
        ...
        switch(e)
        {
            case 0:
                ...
                break;
            case 1:
                edma_userMethod.setErrorCode(1, "Teacher does not exist");
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                edma_userMethod.setErrorCode(4, "Course already has a teacher");
                break;
            case 5:
                edma_userMethod.setErrorCode(5, "Teacher already on this course");
                break;
            case 6:
                edma_userMethod.setErrorCode(6, "Teacher can not teach this course");
                break;
            default:
                throw new RuntimeException("Error in setTeacherOnCourse: Invalid error code: " + e);
        }
        return (e == 0);
    }
     ...
     */
    public SetTeacherOnCourseUserImpl getUserMethod()
    {
