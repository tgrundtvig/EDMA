...
/**
 * The implementation of NotNegInt
 */
public class NotNegIntImpl extends NotNegInt implements IValueInstance
{
     ...
     */
    public NotNegIntImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this NotNegInt to another NotNegInt
     * @param notNegInt  The NotNegInt to compare with
     * @return           A negative integer, zero, or a positive integer as
     *                   this NotNegInt is less than, equal to, or greater than
     *                   the specified NotNegInt
     */
    public int compareTo(NotNegInt notNegInt)
    {
        return edma_domain.valueCompare(value, ((NotNegIntImpl) notNegInt).value);
    }
