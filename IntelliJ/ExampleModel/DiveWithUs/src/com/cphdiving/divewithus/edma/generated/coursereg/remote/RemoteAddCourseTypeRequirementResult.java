 ...
 * 
 */
public class RemoteAddCourseTypeRequirementResult implements AddCourseTypeRequirementResult
{
     ...
     */
    public RemoteAddCourseTypeRequirementResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
