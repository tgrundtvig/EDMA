...
/**
 * The implementation of CourseSize
 */
public class CourseSizeImpl extends CourseSize implements IValueInstance
{
     ...
     */
    public CourseSizeImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    /**
     * Compare this CourseSize to another CourseSize
     * @param courseSize  The CourseSize to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this CourseSize is less than, equal to, or greater
     *                    than the specified CourseSize
     */
    public int compareTo(CourseSize courseSize)
    {
        return edma_domain.valueCompare(value, ((CourseSizeImpl) courseSize).value);
    }
