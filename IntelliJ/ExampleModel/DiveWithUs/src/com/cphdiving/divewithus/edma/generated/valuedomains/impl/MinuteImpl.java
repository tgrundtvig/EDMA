...
/**
 * The implementation of Minute
 */
public class MinuteImpl extends Minute implements IValueInstance
{
     ...
     */
    public MinuteImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Minute to another Minute
     * @param minute  The Minute to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                Minute is less than, equal to, or greater than the
     *                specified Minute
     */
    public int compareTo(Minute minute)
    {
        return edma_domain.valueCompare(value, ((MinuteImpl) minute).value);
    }
