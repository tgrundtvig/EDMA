...
import com.cphdiving.divewithus.edma.generated.valuedomains.AnyInt;
...
/**
 * The implementation of AnyInt
 */
public class AnyIntImpl extends AnyInt implements IValueInstance
{
     ...
     */
    public AnyIntImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(17 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this AnyInt to another AnyInt
     * @param anyInt  The AnyInt to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                AnyInt is less than, equal to, or greater than the
     *                specified AnyInt
     */
    public int compareTo(AnyInt anyInt)
    {
        return edma_domain.valueCompare(value, ((AnyIntImpl) anyInt).value);
    }
