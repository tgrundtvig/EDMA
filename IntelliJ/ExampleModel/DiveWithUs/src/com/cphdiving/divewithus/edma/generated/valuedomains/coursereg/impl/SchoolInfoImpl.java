...
/**
 * The implementation of SchoolInfo
 */
public class SchoolInfoImpl extends SchoolInfo implements IValueInstance
{
     ...
     */
    public SchoolInfoImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(32 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this SchoolInfo to another SchoolInfo
     * @param schoolInfo  The SchoolInfo to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this SchoolInfo is less than, equal to, or greater
     *                    than the specified SchoolInfo
     */
    public int compareTo(SchoolInfo schoolInfo)
    {
        return edma_domain.valueCompare(value, ((SchoolInfoImpl) schoolInfo).value);
    }
