...
/**
 * The implementation of Year
 */
public class YearImpl extends Year implements IValueInstance
{
    ...
    /**
     * Compare this Year to another Year
     * @param year  The Year to compare with
     * @return      A negative integer, zero, or a positive integer as this
     *              Year is less than, equal to, or greater than the specified
     *              Year
     */
    public int compareTo(Year year)
    {
        return edma_domain.valueCompare(value, ((YearImpl) year).value);
    }
