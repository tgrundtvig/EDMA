 ...
 * 
 */
public class RemoteCreateStudentResult implements CreateStudentResult
{
     ...
     */
    public RemoteCreateStudentResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc, StudentID id)
    {
