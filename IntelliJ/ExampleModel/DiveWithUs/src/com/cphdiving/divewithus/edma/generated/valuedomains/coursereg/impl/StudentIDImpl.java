...
/**
 * The implementation of StudentID
 */
public class StudentIDImpl extends StudentID implements IValueInstance
{
     ...
     */
    public StudentIDImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(39 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this StudentID to another StudentID
     * @param studentID  The StudentID to compare with
     * @return           A negative integer, zero, or a positive integer as
     *                   this StudentID is less than, equal to, or greater than
     *                   the specified StudentID
     */
    public int compareTo(StudentID studentID)
    {
        return edma_domain.valueCompare(value, ((StudentIDImpl) studentID).value);
    }
