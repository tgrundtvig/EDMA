 ...
 */
public class SecondImpl extends Second implements IValueInstance
{
     ...
     */
    public SecondImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Second to another Second
     * @param second  The Second to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                Second is less than, equal to, or greater than the
     *                specified Second
     */
    public int compareTo(Second second)
    {
        return edma_domain.valueCompare(value, ((SecondImpl) second).value);
    }
