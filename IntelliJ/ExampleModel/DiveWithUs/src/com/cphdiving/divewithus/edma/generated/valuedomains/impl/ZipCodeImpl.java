...
/**
 * The implementation of ZipCode
 */
public class ZipCodeImpl extends ZipCode implements IValueInstance
{
     ...
     */
    public ZipCodeImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(15 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this ZipCode to another ZipCode
     * @param zipCode  The ZipCode to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 ZipCode is less than, equal to, or greater than the
     *                 specified ZipCode
     */
    public int compareTo(ZipCode zipCode)
    {
        return edma_domain.valueCompare(value, ((ZipCodeImpl) zipCode).value);
    }
