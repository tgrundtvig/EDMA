 ...
 * 
 */
public class EDMA_GetAllCourseTypes extends AView implements IView
{
    private GetAllCourseTypesUserImpl edma_userMethod;
     ...
     */
    public EDMA_GetAllCourseTypes(GetAllCourseTypesUserImpl edma_userMethod)
    {
        super("getAllCourseTypes");
    ...
    public void execute(IDataModelView edma_dm)
    {
        ...
        switch(e)
        {
            case 0:
                ...
                break;
            default:
                throw new RuntimeException("Error in getAllCourseTypes: Invalid error code: " + e);
        }
        if(e == 0)
        {
            if(edma_userMethod.getCourseTypeList() == null)
            {
                throw new RuntimeException("Error in getAllCourseTypes: Output parameter courseTypeList is null");
            }
        }
    }
     ...
     */
    public GetAllCourseTypesUserImpl getUserMethod()
    {
