...
/**
 * The implementation of CourseProcessResult
 */
public class CourseProcessResultImpl extends CourseProcessResult implements IValueInstance
{
     ...
     */
    public CourseProcessResultImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(31 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this CourseProcessResult to another CourseProcessResult
     * @param courseProcessResult  The CourseProcessResult to compare with
     * @return                     A negative integer, zero, or a positive
     *                             integer as this CourseProcessResult is less
     *                             than, equal to, or greater than the specified
     *                             CourseProcessResult
     */
    public int compareTo(CourseProcessResult courseProcessResult)
    {
        return edma_domain.valueCompare(value, ((CourseProcessResultImpl) courseProcessResult).value);
    }
     ...
     */
    public CourseInfoList canceled()
    {
        return new CourseInfoListImpl(value[0]);
    }
     ...
     */
    public CourseInfoList running()
    {
        return new CourseInfoListImpl(value[1]);
    }
}
