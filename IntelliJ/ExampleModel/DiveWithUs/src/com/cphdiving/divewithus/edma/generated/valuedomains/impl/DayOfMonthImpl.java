...
/**
 * The implementation of DayOfMonth
 */
public class DayOfMonthImpl extends DayOfMonth implements IValueInstance
{
     ...
     */
    public DayOfMonthImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(2 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this DayOfMonth to another DayOfMonth
     * @param dayOfMonth  The DayOfMonth to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this DayOfMonth is less than, equal to, or greater
     *                    than the specified DayOfMonth
     */
    public int compareTo(DayOfMonth dayOfMonth)
    {
        return edma_domain.valueCompare(value, ((DayOfMonthImpl) dayOfMonth).value);
    }
