...
/**
 * The implementation of CourseName
 */
public class CourseNameImpl extends CourseName implements IValueInstance
{
     ...
     */
    public CourseNameImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this CourseName to another CourseName
     * @param courseName  The CourseName to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this CourseName is less than, equal to, or greater
     *                    than the specified CourseName
     */
    public int compareTo(CourseName courseName)
    {
        return edma_domain.valueCompare(value, ((CourseNameImpl) courseName).value);
    }
