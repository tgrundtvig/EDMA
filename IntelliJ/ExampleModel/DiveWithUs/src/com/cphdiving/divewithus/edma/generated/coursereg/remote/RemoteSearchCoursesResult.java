 ...
 * 
 */
public class RemoteSearchCoursesResult implements SearchCoursesResult
{
     ...
     */
    public RemoteSearchCoursesResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc, CourseInfoList courseList)
    {
