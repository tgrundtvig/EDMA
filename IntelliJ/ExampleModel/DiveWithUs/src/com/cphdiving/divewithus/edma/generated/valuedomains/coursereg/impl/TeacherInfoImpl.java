...
/**
 * The implementation of TeacherInfo
 */
public class TeacherInfoImpl extends TeacherInfo implements IValueInstance
{
     ...
     */
    public TeacherInfoImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(27 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this TeacherInfo to another TeacherInfo
     * @param teacherInfo  The TeacherInfo to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this TeacherInfo is less than, equal to, or greater
     *                     than the specified TeacherInfo
     */
    public int compareTo(TeacherInfo teacherInfo)
    {
        return edma_domain.valueCompare(value, ((TeacherInfoImpl) teacherInfo).value);
    }
