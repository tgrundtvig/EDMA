...
/**
 * The implementation of Millisecond
 */
public class MillisecondImpl extends Millisecond implements IValueInstance
{
     ...
     */
    public MillisecondImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Millisecond to another Millisecond
     * @param millisecond  The Millisecond to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this Millisecond is less than, equal to, or greater
     *                     than the specified Millisecond
     */
    public int compareTo(Millisecond millisecond)
    {
        return edma_domain.valueCompare(value, ((MillisecondImpl) millisecond).value);
    }
