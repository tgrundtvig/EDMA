 ...
 * 
 */
public class RemoteSetTeacherOnCourseResult implements SetTeacherOnCourseResult
{
     ...
     */
    public RemoteSetTeacherOnCourseResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
