 ...
 * 
 */
public class RemoteAddCourseTypeToTeacherResult implements AddCourseTypeToTeacherResult
{
     ...
     */
    public RemoteAddCourseTypeToTeacherResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc)
    {
