...
public class TeacherInfoBuilderImpl implements TeacherInfoBuilderEmail, TeacherInfoBuilderMobile, TeacherInfoBuilderName
{
    ...
    {
        if(name == null) throw new NullPointerException("The field name in TeacherInfo may not be null");
    ...
    {
        if(email == null) throw new NullPointerException("The field email in TeacherInfo may not be null");
    ...
    {
        if(mobile == null) throw new NullPointerException("The field mobile in TeacherInfo may not be null");
