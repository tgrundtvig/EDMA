...
/**
 * The implementation of CourseList
 */
public class CourseListImpl extends CourseList implements IValueInstance
{
     ...
     */
    public CourseListImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(46 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this CourseList to another CourseList
     * @param courseList  The CourseList to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this CourseList is less than, equal to, or greater
     *                    than the specified CourseList
     */
    public int compareTo(CourseList courseList)
    {
        return edma_domain.valueCompare(value, ((CourseListImpl) courseList).value);
    }
    ...
    {
        return new CourseImpl(value[index]);
    }
    ...
    public class CourseListIterator implements Iterator<Course>
    {
        ...
        public Course next()
        {
            return new CourseImpl(value[pos++]);
        }
