...
/**
 * The implementation of Month
 */
public class MonthImpl extends Month implements IValueInstance
{
     ...
     *               Month is less than, equal to, or greater than the specified
     *               Month
     */
    public int compareTo(Month month)
    {
        return edma_domain.valueCompare(value, ((MonthImpl) month).value);
    }
