...
/**
 * The implementation of Email
 */
public class EmailImpl extends Email implements IValueInstance
{
    ...
    /**
     * Compare this Email to another Email
     * @param email  The Email to compare with
     * @return       A negative integer, zero, or a positive integer as this
     *               Email is less than, equal to, or greater than the specified
     *               Email
     */
    public int compareTo(Email email)
    {
        return edma_domain.valueCompare(value, ((EmailImpl) email).value);
    }
