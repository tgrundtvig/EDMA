...
/**
 * The implementation of CourseInfoList
 */
public class CourseInfoListImpl extends CourseInfoList implements IValueInstance
{
     ...
     */
    public CourseInfoListImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    /**
     * Compare this CourseInfoList to another CourseInfoList
     * @param courseInfoList  The CourseInfoList to compare with
     * @return                A negative integer, zero, or a positive integer
     *                        as this CourseInfoList is less than, equal to, or
     *                        greater than the specified CourseInfoList
     */
    public int compareTo(CourseInfoList courseInfoList)
    {
        return edma_domain.valueCompare(value, ((CourseInfoListImpl) courseInfoList).value);
    }
    ...
    {
        return new CourseInfoListIterator();
    }
    ...
    {
        return new CourseInfoImpl(value[index]);
    }
     ...
     * 
     */
    public class CourseInfoListIterator implements Iterator<CourseInfo>
    {
        private int pos;
         ...
         */
        public CourseInfo next()
        {
            return new CourseInfoImpl(value[pos++]);
        }
