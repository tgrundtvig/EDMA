...
/**
 * The implementation of WetsuitSize
 */
public class WetsuitSizeImpl extends WetsuitSize implements IValueInstance
{
     ...
     */
    public WetsuitSizeImpl(Object value)
    {
        this.value = value;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if(21 != inst.edma_getDomain().getIndex()) return false;
    ...
    /**
     * Compare this WetsuitSize to another WetsuitSize
     * @param wetsuitSize  The WetsuitSize to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this WetsuitSize is less than, equal to, or greater
     *                     than the specified WetsuitSize
     */
    public int compareTo(WetsuitSize wetsuitSize)
    {
        return edma_domain.valueCompare(value, ((WetsuitSizeImpl) wetsuitSize).value);
    }
