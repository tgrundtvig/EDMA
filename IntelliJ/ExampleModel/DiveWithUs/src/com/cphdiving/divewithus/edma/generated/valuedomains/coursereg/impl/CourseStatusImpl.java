...
/**
 * The implementation of CourseStatus
 */
public class CourseStatusImpl extends CourseStatus implements IValueInstance
{
     ...
     */
    public CourseStatusImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this CourseStatus to another CourseStatus
     * @param courseStatus  The CourseStatus to compare with
     * @return              A negative integer, zero, or a positive integer as
     *                      this CourseStatus is less than, equal to, or greater
     *                      than the specified CourseStatus
     */
    public int compareTo(CourseStatus courseStatus)
    {
        return edma_domain.valueCompare(value, ((CourseStatusImpl) courseStatus).value);
    }
