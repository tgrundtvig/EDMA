...
public class BinarySearchSpecialComparator
{
	public static <K, E> int getIndexEqual(	CompareFunction<K, E> comparator,
											K key,
											E[] array,
											int begin,
											int end)
	...
	public static <K, E> int getIndexLower(	CompareFunction<K, E> comparator,
											K key,
											E[] array,
											int begin,
											int end)
	...
	public static <K, E> int getIndexFloor(	CompareFunction<K, E> comparator,
											K key,
											E[] array,
											int begin,
											int end)
	...
	public static <K, E> int getIndexHigher(CompareFunction<K, E> comparator,
											K key,
											E[] array,
											int begin,
											int end)
	...
	public static <K, E> int getIndexCeiling(	CompareFunction<K, E> comparator,
												K key,
												E[] array,
												int begin,
												int end)
