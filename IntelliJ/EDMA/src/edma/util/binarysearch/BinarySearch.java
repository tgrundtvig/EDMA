...
{
	public static <K> int getIndexEqual(Comparator<K> comparator,
										K key,
										K[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexLower(Comparator<K> comparator,
										K key,
										K[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexFloor(Comparator<K> comparator,
										K key,
										K[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexHigher(	Comparator<K> comparator,
											K key,
											K[] array,
											int begin,
											int end)
	...
	public static <K> int getIndexCeiling(	Comparator<K> comparator,
											K key,
											K[] array,
											int begin,
											int end)
