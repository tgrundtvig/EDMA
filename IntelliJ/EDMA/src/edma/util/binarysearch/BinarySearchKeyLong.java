...
public class BinarySearchKeyLong
{
	public static <K> int getIndexEqual(CompareFunctionKeyLong<K> comparator,
										K key,
										long[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexLower(CompareFunctionKeyLong<K> comparator,
										K key,
										long[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexFloor(CompareFunctionKeyLong<K> comparator,
										K key,
										long[] array,
										int begin,
										int end)
	...
	public static <K> int getIndexHigher(	CompareFunctionKeyLong<K> comparator,
											K key,
											long[] array,
											int begin,
											int end)
	...
	public static <K> int getIndexCeiling(	CompareFunctionKeyLong<K> comparator,
											K key,
											long[] array,
											int begin,
											int end)
